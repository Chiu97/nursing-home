...
import myAvatar from '../style/imgs/careAvatar.jpg';
...
import AvatarList from '../routes/AvatarList';
const { Header } = Layout;
        ...
        return (
            <Header className="custom-theme header" >
                ...
                >
                    ...
                    {/* <img src={AvatarList[ava]} alt="头像" size="large" /> */}
                    <SubMenu title={<span className="avatar"><img src={myAvatar} alt="头像" size="large" /><i className="on bottom b-white" /></span>}>
